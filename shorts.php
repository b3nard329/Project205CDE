...
<link rel="stylesheet" type="text/css" href="homepage.css"/>
  ...
  <script type="text/javascript">
	$(document).on("click", ".identifyingClass", function () {
	 ...
	 document.getElementById("item_image").src = "picture/men/short/" + image;
...
<div class="container-fluid">
	...
	$sql = "SELECT id, item_name, price, quantity,image FROM product WHERE categories='short'";
	...
	<section class="products">
		...
		<div class="product-card">
		 	<div class="product-image">
		      <a><img class="identifyingClass" onerror="this.src = 'picture/No_available_image.jpg'" src="picture/men/short/<?php echo $row['image']; ?>"
